...
### O que é Busca em Árvore?

A busca em árvore é um método para explorar todas as possibilidades de solução de um problema. Imagine um mapa de possibilidades onde:
- **Cada nó** = um estado do labirinto (posição do ratinho)
- **Cada aresta** = um movimento possível
- **Raiz** = posição inicial
- **Objetivo** = encontrar um caminho até a posição final

### Diferenças Entre Algoritmos

**Com Informação (Heurística):**
- Usam conhecimento sobre o objetivo (ex: distância de Manhattan)
- Geralmente mais rápidos
- Exemplos: Greedy, A*, IDA*

**Sem Informação:**
- Exploram "cegamente" sem conhecimento do objetivo
- Garantem encontrar a solução ótima (alguns)
- Exemplos: BFS, DFS, Amplitude
...
### Algoritmos de Busca em Profundidade (Depth-First)
- https://en.wikipedia.org/wiki/Depth-first_search

### A* Algorithm
- https://en.wikipedia.org/wiki/A*_search_algorithm

### Heurística e Distância de Manhattan
